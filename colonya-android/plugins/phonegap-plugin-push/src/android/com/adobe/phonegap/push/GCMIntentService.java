...
public class GCMIntentService extends GcmListenerService implements PushConstants {
    ...
    public void onMessageReceived(String from, Bundle extras) {
        ...
        if (extras != null) {
            ...
            // MODIFICACION PARA LAS NOTIFICACIONES DISMISSED
            PushPlugin.sendExtras(extras);
        }
    }
    ...
    private String normalizeKey(String key) {
        if (key.equals(BODY) || key.equals(ALERT) || key.equals(GCM_NOTIFICATION_BODY) || key.equals("mensaje") || key.equals("msg")) {
            return MESSAGE;
    ...
    private void showNotificationIfPossible (Context context, Bundle extras) {
        ...
        /////////////////////////////////////////////////////////
        ////// AÑADIDO A PELO POR PETICION DEL CLIENTE RSI //////
        /////////////////////////////////////////////////////////
        SharedPreferences pref = context.getSharedPreferences("banca_settings", 0);
        boolean canPush = pref.getBoolean("AllowPush", false);
        extras.putString(TITLE, "Ruralvía");
        extras.putString(ICON, "ic_small_notification");
        extras.putString(IMAGE, "www/img/ic_large_notification.png");
         if(extras.getBoolean(FOREGROUND, false)) {
            extras.putString(CONTENT_AVAILABLE, "1");
        }
        ...
        if (((message != null && message.length() != 0) || (title != null && title.length() != 0)) && canPush) {

...
avisos = (function () {
    ...
    var refrescarListaMensajes = function () {
        ...
        // alert("refrescarListaMensajes:::: "+JSON.stringify(obj));
    ...
    var comprobarVolverPrimeraVez = function () {
        if(localStorage.getItem("volcado") === "true" || localStorage.getItem("volcado") === true) {
                localStorage.setItem("volcado", false);
                return true;
        } else {
            return false;
        }
    ...
    var volverAtrasPrimeraVez = function () {
        
                // setTimeout(function(){
                    // alert("vieneDeVolcado timeout");
                    // $("#atras-avisos").click();
                    portal.mostrar();
    ...
    var reloadActivePushUser = function (fecha) {
        ...
        var result = [];
        var promise = $.Deferred();
        // alert("reloadActivePushUser");
        if (activeUsers.length > 0) {
            activeUsers.map(function (user) {
                // alert("reloadActivePushUser desde portal.mostrar");
        ...
        function getAllMessages(user) {
            ...
            if (localStorage.getItem("vieneDeVolcado") === "true" || localStorage.getItem("vieneDeVolcado") === true) {
                jsonParam.fecha = "2016-10-20T10:10:00";
            } else {
            ...
            ///////BORRAR!!!
            // jsonParam.fecha = "2016-10-20T10:10:00";
            localStorage.setItem("vieneDeVolcado", false);
            // alert("jsonParam.fecha    " +jsonParam.fecha);
            // alert("vieneDeVolcado"+ localStorage.getItem("vieneDeVolcado"));

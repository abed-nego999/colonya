...
public class OfficeDTO {
    ...
    String codigoEntidad, codigoOficina, nombreEntidad, direccion, codigoPostal, codigoProvincia, mail,
            telefono, indCajero, latitud, longitud, nombreOficina, nombreLocalidad, nombreProvincia,
            resultado, horario, festivos;
